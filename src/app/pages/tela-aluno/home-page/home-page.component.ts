...
export class HomePageComponent implements OnInit {
  ...
  constructor(public uploadSelfie : UploadSelfieService,public selfieStudent : SelfieStudent, public cardStatusService : CardStatusService,private http: HttpClient) { }
